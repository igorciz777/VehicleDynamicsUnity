...
namespace VehicleDynamics
{
    public class Differential : MonoBehaviour
    {
        ...
        public (float frontTorque, float rearTorque) GetCenterDiffTorque(float inputTorque, float frontOmega, float rearOmega)
        {
            // TODO: Implement center differential logic
            return CalculateCenterDiff(inputTorque);
        }
        ...
        private (float left, float right) CalculateCenterDiff(float inputTorque)
        {
            // TODO: Implement center differential logic
            return (inputTorque * 0.5f, inputTorque * 0.5f);
        }
